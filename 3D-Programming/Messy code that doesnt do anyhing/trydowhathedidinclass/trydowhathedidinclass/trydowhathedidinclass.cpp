// trydowhathedidinclass.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
void processInput(GLFWwindow* window); //get key -> press -> do something
